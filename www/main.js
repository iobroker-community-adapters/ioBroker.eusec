...
<nav>
    <ul>
        <!-- eusec: Add, Config and Net removed - the adapter passes the go2rtc configuration as JSON on the
         command line, so /api/config answers 410 and a stream added by hand is gone on restart. Net pulled
         vis-network from unpkg.com, which is blank on a host without internet access -->
